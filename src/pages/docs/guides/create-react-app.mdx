...
There are two ways to add Tailwind CSS to Create React App:
1. Eject Create React App so you can add the PostCSS plugins to the Webpack configuration
2. Use CRACO to override the PostCSS configuration

### Eject Create React App

Once ejected, look in the `webpack.config.js` file for the `postcss-loader`. 
